...
/*# sourceURL=ace/css/ace_editor.css */</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>
  ...
  <!-- third party -->
    <script src="./form_files/angular.min.js.download"></script>
    <script src="./form_files/angular-translate.min.js.download"></script>
    <script src="./form_files/ng-file-upload.min.js.download"></script>
    <script src="./form_files/jquery.min.js.download"></script>
    <script src="./form_files/bootstrap.min.js.download"></script>
    <script src="./form_files/utf8.js.download"></script>
    <link rel="stylesheet" href="./form_files/bootstrap.min.css">
    <script type="text/javascript" src="./form_files/ace.js.download"></script>
    <script type="text/javascript" src="./form_files/ui-ace.js.download"></script>
    <script type="text/javascript" src="./form_files/ext-language_tools.js.download"></script>
    <script type="text/javascript" src="./form_files/ext-modelist.js.download"></script>
  <!-- /third party -->

  <!-- Comment if you need to use raw source code -->
    <link href="./form_files/angular-filemanager.min.css" rel="stylesheet">
    <script src="./form_files/angular-filemanager.min.js.download"></script>
  <!-- /Comment if you need to use raw source code -->
...
<script src="./form_files/theme-chrome.js.download"></script><script src="./form_files/mode-html.js.download"></script><script src="./form_files/mode-php.js.download"></script></head>
  ...
  <div class="user-container container-fluid ng-scope" ng-controller="UserController as user">
    ...
    <div class="container-fluid">
        ...
        <div class="row visible-xs" style="line-height:30px;">
            ...
            <div class="col-md-8">
                <div class="pull-left" style="line-height: 54px;" ng-show="&#39;000webhost&#39; == config.theme"><img class="logo" src="./form_files/logo.png" alt="logo" title="000webhost" height="34px"></div>
    ...
    <!-- ngRepeat: (key, dir) in fileNavigator.currentPath track by key --><li ng-repeat="(key, dir) in fileNavigator.currentPath track by key" ng-class="{&#39;active&#39;:$last}" class="animated fast fadeIn ng-scope active">
        ...
        <div class="top-action">
            <div class="hidden-xs top-action__breadcrumbs flex">
                <img class="pull-left logo webhost-logo" src="./form_files/000-logo-white.svg" alt="logo" title="000webhost" ng-show="&#39;000webhost&#39; == config.theme">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="text-center">
          <img id="imagepreview-target" class="preview" alt="form.php" ng-class="{&#39;loading&#39;: apiMiddleware.apiHandler.inprocess}">
      ...
      <!-- ngRepeat: tempItem in temps --><li ng-repeat="tempItem in temps" class="ng-scope">
        ...
        <div class="detail-sources">
          <div class="like-code mr5 ng-binding">
            <b class="ng-binding">Destination:</b> /public_html/form.php
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <form ng-submit="rename()" class="ng-pristine ng-valid">
            ...
            <div class="modal-body">
              <label class="radio ng-binding">Enter new name for <b class="ng-binding">form.php</b></label>
            ...
            <div class="modal-body">
              ...
              <div ng-hide="apiMiddleware.apiHandler.asyncSuccess">
                  <div ng-hide="config.allowedActions.compressChooseName" class="ng-binding ng-hide">
                    Are you sure to compress <b class="ng-binding">form.php</b> ?
                  </div>
    ...
    <div class="modal-content">
        <form ng-submit="extract()" class="ng-pristine ng-valid">
            ...
            <div class="modal-body">
              ...
              <div ng-hide="apiMiddleware.apiHandler.asyncSuccess">
                  <label class="radio ng-binding">Enter the folder name for the extraction of <b class="ng-binding">form.php</b></label>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form ng-submit="edit()" class="ng-pristine ng-valid">
            ...
            <div class="modal-body">
                <label class="radio bold ng-binding">/public_html/form.php</label>
                <span class="label label-warning ng-binding ng-hide" ng-show="apiMiddleware.apiHandler.inprocess">Loading ...</span>
                <div id="code-editor" ui-ace="{
                    require: [&#39;ace/ext/language_tools&#39;,&#39;ace/ext/modelist&#39;],
                      ...
                      mode: codeEditor.mode}" ng-model="singleSelection().tempModel.content" ng-show="!apiMiddleware.apiHandler.inprocess" class="ng-pristine ng-untouched ng-valid ace_editor ace-chrome ng-not-empty"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; top: 14px; left: 51px;"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 47px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; top: 0px; left: 0px; width: 47px;"><div class="ace_gutter-cell ace_gutter-active-line " style="height: 14px; top: 0px;">1<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 14px;">2<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 28px;">3<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 42px;">4<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 56px;">5<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 70px;">6<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 84px;">7<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 98px;">8<span style="display: none; height: 14px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 112px;">9<span style="display: none; height: 14px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 126px;">10<span class="ace_fold-widget ace_start ace_open" style="height: 14px; display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 140px;">11<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 154px;">12<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 168px;">13<span class="ace_fold-widget ace_start ace_open" style="height: 14px; display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 182px;">14<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 196px;">15<span style="display: none; height: 14px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 210px;">16<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 224px;">17<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 238px;">18<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 252px;">19<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 266px;">20<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 280px;">21<span style="display: inline-block; height: 14px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 294px;">22<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 308px;">23<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 322px;">24<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 336px;">25<span style="display: inline-block; height: 14px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 350px;">26<span style="display: none;"></span></div></div></div><div class="ace_scroller" style="line-height: 14px; left: 47px; right: 10px; bottom: 0px;"><div class="ace_content" style="top: 0px; left: 0px; width: 811px; height: 378px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 540px; visibility: visible;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 14px; top: 0px; left: 0px; right: 0px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; top: 0px; left: 0px;"><div class="ace_line_group" style="height: 14px; top: 0px;"><div class="ace_line" style="height: 14px;"><span class="ace_support ace_php_tag">&lt;?php</span></div></div><div class="ace_line_group" style="height: 14px; top: 14px;"><div class="ace_line" style="height: 14px;"></div></div><div class="ace_line_group" style="height: 14px; top: 28px;"><div class="ace_line" style="height: 14px;"><span class="ace_support ace_function">require_once</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">"dbconfig.php"</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 42px;"><div class="ace_line" style="height: 14px;"></div></div><div class="ace_line_group" style="height: 14px; top: 56px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$userid</span> <span class="ace_keyword ace_operator">=</span><span class="ace_variable ace_language">$_POST</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"Userid"</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 70px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$name</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable ace_language">$_POST</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"Name"</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 84px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$dep</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable ace_language">$_POST</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"Department"</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 98px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$ac_year</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable ace_language">$_POST</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"Academic_year"</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 112px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$year</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable ace_language">$_POST</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"Year"</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 126px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$from</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable ace_language">$_POST</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"User_from"</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 140px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$bus_fees</span> <span class="ace_keyword ace_operator">=</span><span class="ace_variable ace_language">$_POST</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"Bus_fees"</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 154px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$paid_fees</span> <span class="ace_keyword ace_operator">=</span><span class="ace_variable ace_language">$_POST</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"Paid_fees"</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 168px;"><div class="ace_line" style="height: 14px;"></div></div><div class="ace_line_group" style="height: 14px; top: 182px;"><div class="ace_line" style="height: 14px;"></div></div><div class="ace_line_group" style="height: 14px; top: 196px;"><div class="ace_line" style="height: 14px;"><span class="ace_comment">//check account already register or not</span></div></div><div class="ace_line_group" style="height: 14px; top: 210px;"><div class="ace_line" style="height: 14px;"></div></div><div class="ace_line_group" style="height: 14px; top: 224px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$query</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_string">"SELECT * FROM form WHERE user_id LIKE '</span><span class="ace_variable">$userid</span><span class="ace_string">'"</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 238px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$res</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function">mysqli_query</span><span class="ace_paren ace_lparen">(</span><span class="ace_variable">$con</span><span class="ace_punctuation ace_operator">,</span> <span class="ace_variable">$query</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 252px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$data</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function">mysqli_fetch_array</span><span class="ace_paren ace_lparen">(</span><span class="ace_variable">$res</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 266px;"><div class="ace_line" style="height: 14px;"></div></div><div class="ace_line_group" style="height: 14px; top: 280px;"><div class="ace_line" style="height: 14px;"><span class="ace_keyword">if</span><span class="ace_paren ace_lparen">(</span><span class="ace_variable">$data</span><span class="ace_paren ace_lparen">[</span><span class="ace_constant ace_numeric">0</span><span class="ace_paren ace_rparen">]</span> <span class="ace_keyword ace_operator">&gt;=</span> <span class="ace_constant ace_numeric">1</span><span class="ace_paren ace_rparen">)</span><span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height: 14px; top: 294px;"><div class="ace_line" style="height: 14px;">    <span class="ace_comment">//account exists</span></div></div><div class="ace_line_group" style="height: 14px; top: 308px;"><div class="ace_line" style="height: 14px;">    <span class="ace_support ace_function">echo</span> <span class="ace_support ace_function">json_encode</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">"Your Form already submitted"</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 322px;"><div class="ace_line" style="height: 14px;">    </div></div><div class="ace_line_group" style="height: 14px; top: 336px;"><div class="ace_line" style="height: 14px;"><span class="ace_paren ace_rparen">}</span><span class="ace_keyword">else</span><span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height: 14px; top: 350px;"><div class="ace_line" style="height: 14px;">    <span class="ace_comment">//create account</span></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="display: block; top: 0px; left: 4px; width: 7px; height: 14px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 15px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 15px; height: 658px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 15px; left: 47px; right: 10px;"><div class="ace_scrollbar-inner" style="height: 15px; width: 811px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;"></div></div></div>
                <!-- ngInclude: --><div ng-include="" data-src="&#39;error-bar&#39;" class="clearfix ng-scope">
  <div class="label label-danger error-msg pull-left animated fadeIn ng-scope ng-hide" ng-show="apiMiddleware.apiHandler.error">
    <i class="glyphicon glyphicon-remove-circle"></i>
    <span class="ng-binding"></span>
...
<script type="text/ng-template" id="selected-files-msg" class="ng-scope">
  ...
  <div ng-show="temps.length > 1 &amp;&amp; showDetails">
    ...
    <!-- ngInclude: config.tplPath + '/item-context-menu.html' --><div ng-include="config.tplPath + &#39;/item-context-menu.html&#39;" class="ng-scope"><div id="context-menu" class="dropdown clearfix animated fast fadeIn ng-scope" style="left: 483px; top: 199px; display: none;">
...
<li class="btn-flat ng-scope" ng-show="config.allowedActions.remove">
    ...
    <div class="row login-page ng-hide" ng-hide="user.status">
      <div class="col-md-4 col-md-offset-4">
        <h3><img src="./form_files/logo-colored.svg" class="logo" alt="logo" ng-show="&#39;000webhost&#39; == user.config.theme">File Manager</h3>
