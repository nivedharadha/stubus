...
/*# sourceURL=ace/css/ace_editor.css */</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>
  ...
  <!-- third party -->
    <script src="./dbconfig_files/angular.min.js.download"></script>
    <script src="./dbconfig_files/angular-translate.min.js.download"></script>
    <script src="./dbconfig_files/ng-file-upload.min.js.download"></script>
    <script src="./dbconfig_files/jquery.min.js.download"></script>
    <script src="./dbconfig_files/bootstrap.min.js.download"></script>
    <script src="./dbconfig_files/utf8.js.download"></script>
    <link rel="stylesheet" href="./dbconfig_files/bootstrap.min.css">
    <script type="text/javascript" src="./dbconfig_files/ace.js.download"></script>
    <script type="text/javascript" src="./dbconfig_files/ui-ace.js.download"></script>
    <script type="text/javascript" src="./dbconfig_files/ext-language_tools.js.download"></script>
    <script type="text/javascript" src="./dbconfig_files/ext-modelist.js.download"></script>
  <!-- /third party -->

  <!-- Comment if you need to use raw source code -->
    <link href="./dbconfig_files/angular-filemanager.min.css" rel="stylesheet">
    <script src="./dbconfig_files/angular-filemanager.min.js.download"></script>
  <!-- /Comment if you need to use raw source code -->
...
<script src="./dbconfig_files/theme-chrome.js.download"></script><script src="./dbconfig_files/mode-html.js.download"></script><script src="./dbconfig_files/mode-php.js.download"></script></head>
  ...
  <div class="user-container container-fluid ng-scope" ng-controller="UserController as user">
    ...
    <div class="container-fluid">
        ...
        <div class="row visible-xs" style="line-height:30px;">
            ...
            <div class="col-md-8">
                <div class="pull-left" style="line-height: 54px;" ng-show="&#39;000webhost&#39; == config.theme"><img class="logo" src="./dbconfig_files/logo.png" alt="logo" title="000webhost" height="34px"></div>
    ...
    <!-- ngRepeat: (key, dir) in fileNavigator.currentPath track by key --><li ng-repeat="(key, dir) in fileNavigator.currentPath track by key" ng-class="{&#39;active&#39;:$last}" class="animated fast fadeIn ng-scope active">
        ...
        <div class="top-action">
            <div class="hidden-xs top-action__breadcrumbs flex">
                <img class="pull-left logo webhost-logo" src="./dbconfig_files/000-logo-white.svg" alt="logo" title="000webhost" ng-show="&#39;000webhost&#39; == config.theme">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="text-center">
          <img id="imagepreview-target" class="preview" alt="dbconfig.php" ng-class="{&#39;loading&#39;: apiMiddleware.apiHandler.inprocess}">
  ...
  <div ng-show="temps.length &gt; 1 &amp;&amp; showDetails" class="ng-scope ng-hide">
    <ul class="selected-file-details">
      <!-- ngRepeat: tempItem in temps --><li ng-repeat="tempItem in temps" class="ng-scope">
        <b class="ng-binding">dbconfig.php</b>
      ...
      <!-- ngRepeat: tempItem in temps --><li ng-repeat="tempItem in temps" class="ng-scope">
        ...
        <div class="detail-sources">
          <div class="like-code mr5 ng-binding">
            <b class="ng-binding">Destination:</b> /public_html/dbconfig.php
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <form ng-submit="rename()" class="ng-pristine ng-valid">
            ...
            <div class="modal-body">
              <label class="radio ng-binding">Enter new name for <b class="ng-binding">dbconfig.php</b></label>
            ...
            <div class="modal-body">
              ...
              <div ng-hide="apiMiddleware.apiHandler.asyncSuccess">
                  <div ng-hide="config.allowedActions.compressChooseName" class="ng-binding ng-hide">
                    Are you sure to compress <b class="ng-binding">dbconfig.php</b> ?
                  </div>
    ...
    <div class="modal-content">
        <form ng-submit="extract()" class="ng-pristine ng-valid">
            ...
            <div class="modal-body">
              ...
              <div ng-hide="apiMiddleware.apiHandler.asyncSuccess">
                  <label class="radio ng-binding">Enter the folder name for the extraction of <b class="ng-binding">dbconfig.php</b></label>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form ng-submit="edit()" class="ng-pristine ng-valid">
            ...
            <div class="modal-body">
                <label class="radio bold ng-binding">/public_html/dbconfig.php</label>
                <span class="label label-warning ng-binding ng-hide" ng-show="apiMiddleware.apiHandler.inprocess">Loading ...</span>
                <div id="code-editor" ui-ace="{
                    require: [&#39;ace/ext/language_tools&#39;,&#39;ace/ext/modelist&#39;],
                      ...
                      mode: codeEditor.mode}" ng-model="singleSelection().tempModel.content" ng-show="!apiMiddleware.apiHandler.inprocess" class="ng-pristine ng-untouched ng-valid ace_editor ace-chrome ng-not-empty"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; top: 14px; left: 51px;"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 47px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; top: 0px; left: 0px; width: 47px;"><div class="ace_gutter-cell ace_gutter-active-line " style="height: 14px; top: 0px;">1<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 14px;">2<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 28px;">3<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 42px;">4<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 56px;">5<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 70px;">6<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 84px;">7<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 98px;">8<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 112px;">9<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 126px;">10<span class="ace_fold-widget ace_start ace_open" style="height: 14px; display: inline-block;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 140px;">11<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 154px;">12<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 168px;">13<span class="ace_fold-widget ace_start ace_open" style="height: 14px; display: inline-block;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 182px;">14<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 196px;">15<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 210px;">16<span style="display: none;"></span></div></div></div><div class="ace_scroller" style="line-height: 14px; left: 47px; right: 0px; bottom: 0px;"><div class="ace_content" style="top: 0px; left: 0px; width: 821px; height: 378px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 540px; visibility: visible;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 14px; top: 0px; left: 0px; right: 0px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; top: 0px; left: 0px;"><div class="ace_line_group" style="height: 14px; top: 0px;"><div class="ace_line" style="height: 14px;"><span class="ace_support ace_php_tag">&lt;?php</span></div></div><div class="ace_line_group" style="height: 14px; top: 14px;"><div class="ace_line" style="height: 14px;"></div></div><div class="ace_line_group" style="height: 14px; top: 28px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$db_host</span> <span class="ace_keyword ace_operator">=</span><span class="ace_string">'localhost'</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 42px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$db_user</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_string">'id16576613_registernivi'</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 56px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$db_pass</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_string">'~cB8*#h!&gt;!pWY6&lt;-'</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 70px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$db_name</span> <span class="ace_keyword ace_operator">=</span><span class="ace_string">'id16576613_register'</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 84px;"><div class="ace_line" style="height: 14px;"></div></div><div class="ace_line_group" style="height: 14px; top: 98px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$con</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function">mysqli_connect</span><span class="ace_paren ace_lparen">(</span><span class="ace_variable">$db_host</span><span class="ace_punctuation ace_operator">,</span><span class="ace_variable">$db_user</span><span class="ace_punctuation ace_operator">,</span><span class="ace_variable">$db_pass</span><span class="ace_punctuation ace_operator">,</span><span class="ace_variable">$db_name</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 112px;"><div class="ace_line" style="height: 14px;"></div></div><div class="ace_line_group" style="height: 14px; top: 126px;"><div class="ace_line" style="height: 14px;"><span class="ace_keyword">if</span><span class="ace_paren ace_lparen">(</span><span class="ace_keyword ace_operator">!</span><span class="ace_variable">$con</span><span class="ace_paren ace_rparen">)</span><span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height: 14px; top: 140px;"><div class="ace_line" style="height: 14px;">    <span class="ace_comment">//echo json_encode("connection error");</span></div></div><div class="ace_line_group" style="height: 14px; top: 154px;"><div class="ace_line" style="height: 14px;"><span class="ace_paren ace_rparen">}</span></div></div><div class="ace_line_group" style="height: 14px; top: 168px;"><div class="ace_line" style="height: 14px;"><span class="ace_keyword">else</span><span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height: 14px; top: 182px;"><div class="ace_line" style="height: 14px;">    <span class="ace_comment">//echo json_encode("connection successful");</span></div></div><div class="ace_line_group" style="height: 14px; top: 196px;"><div class="ace_line" style="height: 14px;"><span class="ace_paren ace_rparen">}</span></div></div><div class="ace_line_group" style="height: 14px; top: 210px;"><div class="ace_line" style="height: 14px;"><span class="ace_support ace_php_tag">?&gt;</span></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="display: block; top: 0px; left: 4px; width: 7px; height: 14px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 15px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 15px; height: 224px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 15px; left: 47px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 15px; width: 821px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;"></div></div></div>
                <!-- ngInclude: --><div ng-include="" data-src="&#39;error-bar&#39;" class="clearfix ng-scope">
  <div class="label label-danger error-msg pull-left animated fadeIn ng-scope ng-hide" ng-show="apiMiddleware.apiHandler.error">
    <i class="glyphicon glyphicon-remove-circle"></i>
    <span class="ng-binding"></span>
...
<li class="btn-flat ng-scope" ng-show="config.allowedActions.remove">
    ...
    <div class="row login-page ng-hide" ng-hide="user.status">
      <div class="col-md-4 col-md-offset-4">
        <h3><img src="./dbconfig_files/logo-colored.svg" class="logo" alt="logo" ng-show="&#39;000webhost&#39; == user.config.theme">File Manager</h3>
